...
class Boat:
    def __init__(self):
        self.controlMode = 1                            # 0: remote-control / 1: semi-autonoom / 2: autonoom / 3: simulatie
        self.centralData = CentralData()                # Data object in which every datapoint is stored
        self.communication = Communication(self)        # Communication base handler
    ...
    def sail(self):
        ...
        if self.course.checkCurrentCourse():
            ...
            self.communication.can.setRudder(pidOutput)
